...
export class HistorialserviciosPage implements OnInit {
  ...
  ngOnInit() {
    this.route.queryParams.subscribe(params => {
      ...
      this.fechaInicio = moment(this.datosrecibidos.descripcion.fechaInicio).format("DD/MM/YYYY");
      this.fechaFinalizacion = moment(this.datosrecibidos.descripcion.fechaFinalizacion).format("DD/MM/YYYY");
      this.horaInicio = moment(this.datosrecibidos.descripcion.horaInicio).format("hh:mma");
      this.horaFinalizacion = moment(this.datosrecibidos.descripcion.horaFinalizacion).format("hh:mma");
